...
mod1 <- brm(D ~ 1 + Age + Sex + SCI + SFluency + s(Interview_Date) + (1 | Interviewer) + (1 | ComID/UniqueFamID) + (1| PID), 
            data   = dep_data,
            family = gaussian,
...
## Specifying the model
mod2 <- brm(D ~ 1 + Age + Sex + SCI + SFluency + s(Interview_Date) + Town_Distance + Com_Size + HH_Size + (1 | Interviewer) + (1 | ComID/UniqueFamID) + (1 | PID), 
            data   = dep_data,
            family = gaussian,
            prior = c(prior(normal(0, 0.5), class="Intercept"),
                      prior(exponential(1), class = sd),
...
ggsave(filename = "SumScoreModels_CompleteCase_Posteriors.png", 
...
ggsave(filename = "SumScoreModels_CompleteCase_ICCs.png", 
...
########### Let's plot the effects of the models with PID  ####################################################################################
#######################################################################################################################################################
#######################################################################################################################################################
...
icc_residual_1_v2 <-  ((T1_v2$sigma)^2) / 
  ((T1_v2$sigma)^2 + 
     ...
     (T1_v2$`sd_ComID:UniqueFamID__Intercept`)^2 + 
     (T1_v2$`sd_ComID__Intercept`)^2 + 
...
icc_family_1_v2 <- ((T1_v2$`sd_ComID:UniqueFamID__Intercept`)^2) / 
  ((T1_v2$sigma)^2 + 
     (T1_v2$sd_PID__Intercept)^2 + 
     (T1_v2$`sd_ComID:UniqueFamID__Intercept`)^2 + 
     (T1_v2$`sd_ComID__Intercept`)^2 + 
...
icc_community_1_v2 <- ((T1_v2$`sd_ComID__Intercept`)^2) / 
  ((T1_v2$sigma)^2 + 
     (T1_v2$sd_PID__Intercept)^2 + 
     (T1_v2$`sd_ComID:UniqueFamID__Intercept`)^2 + 
     (T1_v2$`sd_ComID__Intercept`)^2 + 
...
icc_residual_2_v2 <-  ((T2_v2$sigma)^2) / 
  ((T2_v2$sigma)^2 + 
     ...
     (T2_v2$`sd_ComID:UniqueFamID__Intercept`)^2 + 
     (T2_v2$`sd_ComID__Intercept`)^2 + 
...
# Family ICC Calculation for Model 2
  icc_family_2_v2 <- ((T2_v2$`sd_ComID:UniqueFamID__Intercept`)^2) / 
  ((T2_v2$sigma)^2 + 
     (T2_v2$sd_PID__Intercept)^2 + 
     (T2_v2$`sd_ComID:UniqueFamID__Intercept`)^2 + 
     (T2_v2$`sd_ComID__Intercept`)^2 + 
...
# Community ICC Calculation for Model 2
  icc_community_2_v2 <- ((T2_v2$`sd_ComID__Intercept`)^2) / 
  ((T2_v2$sigma)^2 + 
     (T2_v2$sd_PID__Intercept)^2 + 
     (T2_v2$`sd_ComID:UniqueFamID__Intercept`)^2 + 
     (T2_v2$`sd_ComID__Intercept`)^2 + 
...
## Saving these combined plots at a resolution that is readable on a page
ggsave(filename = "SumScoreModels_CompleteCase_wPID_Posteriors.png", 
...
ggsave(filename = "SumScoreModels_CompleteCase_wPID_ICCs.png", 
